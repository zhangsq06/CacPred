...
nums = len(directy)
validX1_data = torch.FloatTensor(traindirectx[int(nums*0.9):])
validX2_data = torch.FloatTensor(trainreversex[int(nums*0.9):])        
validY_data = torch.FloatTensor(traindirecty[int(nums*0.9):])

trainX1_data = torch.FloatTensor(traindirectx[:int(nums*0.9)])
trainX2_data = torch.FloatTensor(trainreversex[:int(nums*0.9)])
trainY_data = torch.FloatTensor(traindirecty[int(nums*0.9):])
########################################
